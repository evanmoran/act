...
(function() {
  ...
  Task = (function() {
    ...
    Task.prototype.update = function(time) {
      ...
      _.extend(this.obj, this._interpolator(eased));
      if (elapsed >= this.duration) {
        this._complete();
      }
    ...
    Task.prototype._start = function() {
      ...
      initialValue = _pickKeys(finalValue, this.obj);
    ...
    Task.prototype._complete = function() {
      ...
      finalValue = _pickKeys(initialValue, this.obj);
  ...
  _pickKeys = function(ks, vs) {
    return _.pick.apply(_, [vs].concat(__slice.call(_.keys(ks))));
  };
